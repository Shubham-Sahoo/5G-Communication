...
if simParameters.PDSCH.NLayers > 4              % Multicodeword transmission
    ...
    simParameters.PDSCH.TargetCodeRate = [900 900]./1024; % Code rate used to calculate transport block sizes
    ...
    simParameters.PDSCH.TargetCodeRate = 900/1024;  % Code rate used to calculate transport block sizes
