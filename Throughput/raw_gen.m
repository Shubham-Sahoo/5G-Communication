    ...
    for codIdx = 1:numel(code_rates)
        ...
        % Toolbox is not installed, 'parfor' defaults to normal 'for' statement
            ...
            elseif(simParameters.PDSCH.Modulation=="16QAM")
                modl = 1;
                modll = cat(1,modl,modl,modl,modl);
                trcc = cat(1,trc,trc,trc,trc);
            ...
            elseif(simParameters.PDSCH.Modulation=="64QAM")
                modl = 2;
                modll = cat(1,modl,modl,modl,modl,modl,modl);
                trcc = cat(1,trc,trc,trc,trc,trc,trc);
                ...
                modl = 3;
                modll = cat(1,modl,modl,modl,modl,modl,modl,modl,modl);
                trcc = cat(1,trc,trc,trc,trc,trc,trc,trc,trc);
